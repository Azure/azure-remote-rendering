...
{
    /// <summary>
    /// Custom (far interaction) hand ray pointer to also cast against remote rendered content.
    /// </summary>
    public class RemoteShellHandRayPointer : ShellHandRayPointer, IRemotePointer
    {
