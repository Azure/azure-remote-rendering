...
/// <summary>
/// A customized version of the MRTK's UwpAppxBuildTools to correctly select the latest version of Visual Studio.
/// </summary>
namespace Microsoft.MixedReality.Toolkit.Build.Editor
{
    public static class CustomUwpAppxBuildTools
    {
        /// <summary>
        ...
        private static readonly VSWhereFindOption[] VSWhereFindOptions =
        {
            ...
            new VSWhereFindOption(
                $@"/C vswhere -all -products * -requires Microsoft.Component.MSBuild -find MSBuild\**\Bin\MSBuild.exe -latest",
                ""),
