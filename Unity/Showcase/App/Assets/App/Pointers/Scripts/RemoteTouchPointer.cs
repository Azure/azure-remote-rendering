...
{
    /// <summary>
    /// Custom touch pointer to also cast against remote rendered content.
    /// </summary>
    public class RemoteTouchPointer : TouchPointer
    {
        ...
        private static readonly ProfilerMarker OnPreSceneQueryPerfMarker = new ProfilerMarker("[Showcase] RemoteTouchPointer.OnPreSceneQuery");
        ...
        private static readonly ProfilerMarker OnSceneQueryPerfMarker = new ProfilerMarker("[Showcase] RemoteTouchPointer.OnSceneQuery");
