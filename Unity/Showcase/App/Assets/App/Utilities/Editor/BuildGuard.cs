...
{
    private static readonly List<BuildTarget> s_supportedPlatforms = new List<BuildTarget> { BuildTarget.StandaloneWindows64, BuildTarget.WSAPlayer, BuildTarget.Android };
